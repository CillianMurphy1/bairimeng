...
public class StatsActivity extends Activity {
    ...
    private void buildUi() {
        ...
        TextView title = Ui.text(this, "收支统计", 25, Ui.INK, Typeface.BOLD);
        title.setGravity(Gravity.CENTER);
        top.addView(title, new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1));
        TextView filter = Ui.text(this, "⌄", 28, Ui.INK, Typeface.BOLD);
        filter.setGravity(Gravity.CENTER);
        top.addView(filter, new LinearLayout.LayoutParams(Ui.dp(this, 42), Ui.dp(this, 42)));
        root.addView(top);
        ...
        TextView summaryTitle = Ui.text(this, "收支总览", 22, Ui.INK, Typeface.BOLD);
        ...
        metrics.addView(metric("收入", PaymentParser.formatMoney(income), Color.rgb(44, 188, 128)));
        summary.addView(metrics);
        root.addView(summary);

        LinearLayout categories = Ui.card(this);
        categories.addView(Ui.text(this, "支出分类", 21, Ui.INK, Typeface.BOLD));
        ...
        if (!hasRows) {
            TextView empty = Ui.text(this, "本月还没有支出数据。", 16, Ui.MUTED, Typeface.NORMAL);
        ...
        asset.addView(Ui.text(this, "资产快照", 21, Ui.INK, Typeface.BOLD));
        ...
        asset.addView(Ui.text(this, "总负债  " + TransactionStore.formatMoneySigned(store.totalByKind("liability")), 16, Ui.MUTED, Typeface.NORMAL));
        root.addView(asset);
        setContentView(scroll);
    }

    private TextView metric(String label, String value, int color) {
        TextView view = Ui.text(this, label + "\n" + value, 20, color, Typeface.BOLD);
    ...
    private LinearLayout categoryRow(String name, long value, long total) {
        ...
        row.addView(Ui.text(this, name, 17, Ui.INK, Typeface.BOLD), new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1));
        TextView amount = Ui.text(this, PaymentParser.formatMoney(value), 17, Ui.WARNING, Typeface.BOLD);
        ...
        bar.addView(filled, new LinearLayout.LayoutParams(0, Ui.dp(this, 8), percent));
        View rest = new View(this);
        bar.addView(rest, new LinearLayout.LayoutParams(0, Ui.dp(this, 8), 100 - percent));
        box.addView(bar);
        return box;
    }
}
